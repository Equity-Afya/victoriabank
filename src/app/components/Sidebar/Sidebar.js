...
const Sidebar = ({ setShowAccounts }) => {
    ...
    const handleTaskListClick = () => {
        setShowTasklist(true); // Set showTasklist to true when Tasklist is clicked
        setShowAccounts(false); // Set showAccounts to false when Tasklist is clicked
    };
